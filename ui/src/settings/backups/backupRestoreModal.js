                    ...
                    t.div(
                        ...
                        t.div(
                            ...
                            t.p(
                                ...
                                t.code(null, "pb_data"),
                                " storage files with the ones from the backup and will restart the application process.",
                            ),
                            t.p(
                                null,
                            ...
                            t.ol(
                                ...
                                t.li(
                                    ...
                                    t.code(null, "pb_data"),
                                    " storage files with the content from the backup (or imports the ",
                                    t.code(null, "data.db"),
                                    " into PostgreSQL for legacy SQLite backups).",
                                ),
                                t.li(null, "Triggers app restart."),
                                t.li(null, "Applies any missing migrations."),
