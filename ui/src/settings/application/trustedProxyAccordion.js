    ...
    return t.details(
        ...
        t.div(
            ...
            t.p(
                null,
                `
                When PGBase is deployed on platforms like Fly or it is accessible through proxies such as
                NGINX, requests from different users will originate from the same IP address (the IP of the proxy
                connecting to your PGBase app).
            `,
            ),
            t.p(
                null,
                ...
                properly configure your proxy and list below the trusted headers that PGBase could use to
                extract the user IP.
            `,
            ),
            ...
            t.ul(
                ...
                t.li(null, "make sure that the PGBase server can be accessed ONLY through the proxy"),
            ),
            t.p(null, "You can clear the headers field if PGBase is not deployed behind a proxy."),
        ),
        t.div(
            { className: "grid sm" },
            t.div(
