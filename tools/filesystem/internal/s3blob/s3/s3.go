...
// https://github.com/arief-fajri/pgbase/discussions/6562.
//
// Example:
//
//	client := &s3.S3{
...
// (see also https://github.com/arief-fajri/pgbase/issues/7153).
//
...
func (s3 *S3) sign(req *http.Request) {
	...
	// and Content-Length zeroing (https://github.com/arief-fajri/pgbase/issues/7523)
